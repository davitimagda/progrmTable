//  https://github.com/HandlebarLabs/react-native-examples-and-tutorials/tree/master/tutorials/multi-theme-button
...
const Button = (props) => {
  ...
  // render() {
  const { onPress, text, disabled, ...rest } = props;
  ...
  return (
    <TouchableOpacity
      ...
      disabled={disabled}
    >
      <Text onPress={onPress} style={textStyles}>
        {text}
      </Text>
    </TouchableOpacity>
  );
